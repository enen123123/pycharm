...
import threading
from socket import*
from multiprocessing import*#使用多进程、多线程模块,例如Process、threading
...
def main():
    ...
    local_addr=('192.168.223.54',8299)
    ...
    try:#异常处理
        while True:
            ...
            client= threading.Thread(target=deal_client,args=(new_socket,dest_addr))
